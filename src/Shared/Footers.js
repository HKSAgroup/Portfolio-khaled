        ...
        <div className="mid-container">
          <footer className="footer pt-16 lg:pb-32 md:pb-28 sm:pb-16 pb-8 grid lg:grid-cols-5 md:grid-cols-4 grid-cols-2 gap-10">
            <div>
              ...
              <p className='text-justify text-sm text-neutral'>Lorem Ipsum has been the has <br /> been indusetry's and to standard <br /> dummy text ever to..</p>
            ...
            <div>
              ...
              <a className="link link-hover text-neutral">+8801760-007083</a>
              <a className="link link-hover text-neutral">uiuxdomith@gmail.com</a>
              <a className="link link-hover text-neutral">Sydney,45754, Australia</a>
            </div>
          </footer>
